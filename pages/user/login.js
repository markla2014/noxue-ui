          ...
          <Card style={{ width: "400px", margin: "50px auto" }}>
            ...
            <CardContent>
              <Grid container spacing={8} alignItems="flex-end">
                ...
                <Grid item>
                  <TextField onChange={this.changeNick} label="用户昵称" />
                </Grid>
              </Grid>
              <Grid container spacing={8} alignItems="flex-end">
                <Grid item>
                ...
                <Grid item>
                  <TextField onChange={this.changeName} label="邮箱或手机号" />
                </Grid>

                <Grid item>
                  <Button size="small" variant="contained" onClick={this.handleClickOpen}>获取验证码</Button>
                </Grid>
              </Grid>
              <Grid container spacing={8} alignItems="flex-end">
                <Grid item>
                ...
                <Grid item>
                  <TextField onChange={this.changeCode} label="邮箱或手机收到的验证码" />
                </Grid>
              </Grid>
              <Grid container spacing={8} alignItems="flex-end">
                <Grid item>
                ...
                <Grid item>
                  <TextField type="password" onChange={this.changeSecret} label="密码" />
                </Grid>
              </Grid>
              <Grid container spacing={8} alignItems="flex-end">
                <Grid item>
                ...
                <Grid item>
                  <TextField type="password" onChange={this.changeSecretConfirm} label="确认密码" />
                </Grid>
              </Grid>
            </CardContent>
            <CardActions>
